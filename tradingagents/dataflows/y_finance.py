...
def get_YFin_data_online(
    ...
    resolved_symbol = resolve_yfinance_ticker(symbol)
    
    # Create ticker object
    ticker = yf.Ticker(resolved_symbol.upper())
...
def get_fundamentals(
    ...
    try:
        resolved_ticker = resolve_yfinance_ticker(ticker)
        ticker_obj = yf.Ticker(resolved_ticker.upper())
